...
<img src="/PHP_CRASH/feedback/img/logo.png" class="w-25 mb-3" alt="">
  <h2>Feedback</h2>
  ...
  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" class="mt-4 w-75">
    ...
    <div class="mb-3">
      ...
      <textarea class="form-control <?php echo !$nameErr ? null : "is-invalid" ?>" id="body" name="body" placeholder="Enter your feedback"></textarea>
      <div class="invalid-feedback">
        <?php echo $bodyErr; ?>
      </div>
    </div>
